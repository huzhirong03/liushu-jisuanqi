...
连码|连码?(\d+(?:[,，]\d+)+)\s*(\d+)|连码"></textarea>
        ...
        <div class="import-modal-content" style="max-width:95%;width:500px;max-height:90vh;overflow:hidden;display:flex;flex-direction:column;">
            ...
            <div id="model-tabs" style="display:flex;gap:0;margin-bottom:0;border-bottom:1px solid rgba(255,255,255,0.1);">
                ...
                <button class="model-tab" data-model="gpt" onclick="switchModelTab('gpt')">
                    <div class="model-tab-name">GPT5</div>
    ...
    const AI_PROVIDERS = {
        ...
        tuzi: {
            ...
            model: 'gemini-3-pro-preview',  // 兔子API - Gemini 3 Pro
        ...
        claude: {
            ...
            shortName: 'Claude',
            url: 'https://api.tu-zi.com/v1/chat/completions',
            model: 'claude-opus-4-5',  // 兔子API - Claude Opus 4.5
            region: 'cn',  // 走阿里云代理
            apiKey: 'sk-SMDJFcugwkRYkb699P71XKdPvqKMAfbjWL1xHBMNngD6oGOa'
        },
        gpt: {
            name: 'GPT-5.1',
            shortName: 'GPT5',
            url: 'https://api.tu-zi.com/v1/chat/completions',
            model: 'gpt-5.1',  // 兔子API - GPT 5.1
            region: 'cn',  // 走阿里云代理
            apiKey: 'sk-J8ayveZilFyHLN6mJTlmEVhDLqJjFGVCSjyuGBPyqdtbKUVT'
        }
    };
